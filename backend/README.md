...
## Project Structure
    ...
    ├── testapiautostoryboa_76291  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_76291`
...
2. Clone this repo and `cd testapiautostoryboa_76291`
